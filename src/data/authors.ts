...
export const primaryAuthor: Author = {
  ...
  bio: {
    fr: "Spécialiste du droit du travail marocain avec plus de 10 ans d'expérience en gestion des ressources humaines et en conseil juridique pour les entreprises marocaines. Responsable du contenu de Salaire Net Maroc, conforme au Code du Travail 2026.",
